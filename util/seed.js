...
var createTransactions = function(data) {
  ...
  return Promise.all(promises).then(function(trasnsactions) {
...
var createExpenditure = function(data) {
  ...
  return Promise.all(promises).then(function(expenditure) {
